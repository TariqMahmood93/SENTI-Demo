...
def _inject_master_css():
    ...
    :root {
        ...
        --panel2:   #E2E8F0;
        --rim:      rgba(0,0,0,0.08);
        --rim2:     rgba(0,0,0,0.15);
        --teal:     #5BB8F5;
        --teal2:    #3AA0E8;
        --teal3:    rgba(91,184,245,0.18);
        --teal4:    rgba(91,184,245,0.09);
        --amber:    #D97706;
        --amber2:   rgba(217,119,6,0.10);
        --rose:     #E11D48;
        --rose2:    rgba(225,29,72,0.10);
        --lilac:    #7C3AED;
        --lilac2:   rgba(124,58,237,0.10);
        --sky:      #0284C7;
        --sky2:     rgba(2,132,199,0.10);
        --green:    #059669;
        --text:     #000000;
        --text2:    #333333;
        --text3:    #555555;
    ...
    [data-testid="stAppViewContainer"]::before {
        ...
        background-image:
            linear-gradient(rgba(91,184,245,0.06) 1px, transparent 1px),
    ...
    [data-testid="stSidebar"] [data-testid="stRadio"] label:has(input:checked) {
        ...
        border-color: rgba(91,184,245,0.4) !important;
        color: #000000 !important;
    }
    ...
    [data-testid="stRadio"] label {
        ...
        border: 1px solid rgba(91,184,245,0.5) !important;
        border-radius: 20px !important;
        font-size: 1.229rem !important;
        cursor: pointer !important;
        transition: all 0.15s ease !important;
        color: #000000 !important;
        background: rgba(91,184,245,0.08) !important;
        font-family: var(--sans) !important;
    }
    [data-testid="stRadio"] label:has(input:checked) {
        border-color: #5BB8F5 !important;
        color: #000000 !important;
        background: rgba(91,184,245,0.28) !important;
    }
